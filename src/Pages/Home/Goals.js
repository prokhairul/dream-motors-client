        ...
        <div className='mb-20'>
            <div className="min-h-max bg-yellow-400">
                <div className="grid grid-cols gap-4 container items-center">
                    <div className='lg:col-start-1 lg:col-end-3 goals-style'>
                        <h1 className="text-5xl font-bold text-slate-900 ">Our Story</h1>
                    ...
                    <div className='lg:col-end-7 lg:col-span-2 goals-style'>
